...
| **Main purpose** | Viewing / reading `.sysml` files (syntax highlighting) | Learning and teaching SysML v2 | Graphical modeling | Writing, parsing and storing SysML v2 models |
| **Textual notation** | View/edit text only | Yes, synchronised with diagrams | Limited text editor | Full textual notation (pilot implementation of the OMG spec) |
| **Graphical diagrams** | No | Yes | Yes | Basic visualisation (`%viz` in Jupyter) |
| **Model validation / parsing** | No | Yes | Yes | Yes, reference parser |
...
| **Main limitation** | View only, no modeling semantics | Element cap; intended for learning and teaching, not production work | Text editing is limited | Manual setup (Docker, JDK 11, sbt, Jupyter); see [README.md](README.md) |
...
**Summary:**
- **VS Code extension:** for viewing only.
...
### CATIA Magic SysML V2 Community Edition

Access CATIA Magic SysML V2 Community Edition here: [3DS software](https://software.3ds.com/)
...
Syson is another tool for SysML V2. It has limitations in its text editor.
